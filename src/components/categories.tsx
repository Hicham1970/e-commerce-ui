 ...
 return (
     <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-2 bg-gray-100 rounded-lg p-2 mb-4 text-sm'>
         {categories.map((category) => (
             <div
                 className={`flex items-center justify-center gap-2 cursor-pointer hover:bg-gray-200 px-2 py-1 rounded-md ${selectedCategory === category.slug ? "bg-white" : "text-gray-500"}`}
                 key={category.name}
