...
const Footer = () => {
    return (
        <div className='mt-16 flex flex-col items-center md:flex-row  md:justify-between gap-8 md:gap-0  md:items-start bg-gray-800 rounded-md p-8'>
            ...
            <div className="flex flex-col gap-4 items-center md:items-start ">
                ...
                <p className="text-sm text-gray-400 ">© 2025 TrendGh</p>
